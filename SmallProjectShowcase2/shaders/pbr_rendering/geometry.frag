...
layout (location = 2) out vec4 gAttr;
...
void main()
{
    ...
    float metalness = texture(tex_metalness, texCoords).r;
    ...
    gAttr.r = roughness * frag_material_attr.g;
    gAttr.g = metalness * frag_material_attr.b;

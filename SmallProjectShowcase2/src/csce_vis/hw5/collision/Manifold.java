...
public class Manifold {
	...
	private void doCollisionResolution() {
		...
		for (Contact c : this.contacts) {
			...
			angaccel_a.addi(MathUtils.cross(unit_tang, radiusvec_a).mul(-tang_scalar * inv_moment_a));
			angaccel_b.addi(MathUtils.cross(unit_tang, radiusvec_b).mul(tang_scalar * inv_moment_b));
